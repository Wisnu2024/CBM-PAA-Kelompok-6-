...
def redesign_city():
    ...
    for _ in range(4): place_building_on_side_of_main_road("D:\\Map Asset\\Big Building.png", (10, 5))
    for _ in range(8): place_building_on_side_of_main_road("D:\\Map Asset\\Medium Building.png", (5, 3))
    for _ in range(12): place_building_on_side_of_main_road("D:\\Map Asset\\Small Building.png", (2, 2))
    for _ in range(15): place_building_on_side_of_main_road("D:\\Map Asset\\House.png", (1, 2))

    # Tempatkan objek secara acak
    place_object_randomly("D:\\Map Asset\\batu.png", (1, 1), 200)
    place_object_randomly("D:\\Map Asset\\kolam.png", (10, 10), 5)
    place_object_randomly("D:\\Map Asset\\pohon.png", (2, 2), 200)
