...
def draw_center_line(image, start, end):
...
def draw_road(image, start, end, is_main_road=False):
    if start[0] == end[0]:  # Jalan vertikal
        for y in range(start[1], end[1] + 1):
...
def place_building_on_side_of_main_road(image_path, size, max_attempts=1000):
    main_road_coords = np.argwhere(main_road_flag)
...
def redesign_city():
    ...
    grass_color = [76, 176, 80]  # Warna hijau untuk area kosong
    ...
    for _ in range(4): place_building_on_side_of_main_road("D:\\Final Project CBM PAA\\Map Asset\\Big Building.png", (10, 5))
    for _ in range(10): place_building_on_side_of_main_road("D:\\Final Project CBM PAA\\Map Asset\\Medium Building.png", (5, 3))
    for _ in range(12): place_building_on_side_of_main_road("D:\\Final Project CBM PAA\\Map Asset\\Small Building.png", (2, 2))
    for _ in range(15): place_building_on_side_of_main_road("D:\\Final Project CBM PAA\\Map Asset\\House.png", (1, 2))

    # Tempatkan objek secara acak
    place_object_randomly("D:\\Final Project CBM PAA\\Map Asset\\batu.png", (1, 1), 200)
    place_object_randomly("D:\\Final Project CBM PAA\\Map Asset\\kolam.png", (10, 10), 10)
    place_object_randomly("D:\\Final Project CBM PAA\\Map Asset\\pohon.png", (2, 2), 200)
